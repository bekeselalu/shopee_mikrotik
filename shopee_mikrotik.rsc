#####################################
# Created By wifianglobal.com 
#####################################
/ip firewall raw
rem [find comment="Shopee - wifianglobal.com"]
add action=add-dst-to-address-list address-list=Mikrotik-Shopee address-list-timeout=1d chain=prerouting comment="Shopee - wifianglobal.com" content=.shopee. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
add action=add-dst-to-address-list address-list=Mikrotik-Shopee address-list-timeout=1d chain=prerouting comment="Shopee - wifianglobal.com" content=.shopeemobile. dst-address-list=!LOCAL-IP src-address-list=LOCAL-IP
